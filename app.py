...
def parse_student_file_from_text(text):
    ...
    and extra summary lines (containing various SGPA values, TOTAL CREDITS, CGPA, etc.)
    are parsed.
    """
...
def create_excel_in_memory(students, selected_subjects_str):
    ...
    Only dynamic keys from each student that match these base names (or extra summary fields) are included.
    """
    ...
    final_cols = ["Sr.", "Seat No.", "Name of Student"] + final_subject_cols + common_cols[2:]
...
if page == "Home":
    ...
    **Instructions:**
    ...
    1. **Upload a PDF file:**  
       The file should contain result ledger data with:
    ...
    2. **Auto-Detection of Subjects:**  
       The app auto-detects subject base names from the PDF (the text between the course code and "*").  
       You can review and modify these names (comma separated) below.  
       For example:  
       **DESIGN & ANALYSIS OF ALGO., MACHINE LEARNING, BLOCKCHAIN TECHNOLOGY, OBJ. ORIENTED MODL. & DESG., SOFT. TEST. & QLTY ASSURANCE, LABORATORY PRACTICE - III, LABORATORY PRACTICE - IV, PROJECT STAGE - I, MOOC - LEARN NEW SKILLS**
